...
<body>
	<form id="frm" name="frm" method="post" action="/usersignup.do">
		...
		<input type="submit" value="db에 넣어라"/>
	</form>
			...
			new daum.Postcode(
					{
						oncomplete : function(data) {
							...
							/* $("[name=sample6_postcode]").val(data.zonecode);
							$("[name=sample6_address]").val(addr); */
